...
<main class="flex-grow-1">
    <div class="container py-4">
        <div class="card shadow bg-secondary rounded-4 main-text">
            <div class="card-body">
                ...
                <?php if ($currentUserId && ($ownsPost || $isAdmin)): ?>
                    <div class="mt-4">
                        ...
                        <a href="<?= BASE_URL ?>controllers/post_delete.php?id=<?= $post['id'] ?>"
                           ...
                           onclick="return confirm('Opravdu chcete smazat tento dotaz?');">Smazat</a>
                    </div>
                <?php endif; ?>
